...
class Mdl_Invoices_Recurring extends Response_Model
{
    ...
    public function default_select()
    {
        $this->db->select("SQL_CALC_FOUND_ROWS ip_invoices.*,
            ...
            IF(recur_end_date > date(NOW()) OR recur_end_date = '1970-01-01', 'active', 'inactive') AS recur_status", false);
    }
    ...
    public function db_array()
    {
        ...
        if ($db_array['recur_end_date']) {
            ...
            $db_array['recur_end_date'] = '1970-01-01';
        }
    ...
    {
        $this->filter_where("recur_next_date <= date(NOW()) AND (recur_end_date > date(NOW()) OR recur_end_date = '1970-01-01')");
        return $this;
    }
