        ...
        <div class="modal-header">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active">
                    <a href="#one" aria-controls="one" role="tab" data-toggle="tab"><?php _trans("create_".$group); ?></a>
                </li>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="one">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            <select name="client_id" id="create_invoice_client_id" class="client-id-select form-control" autofocus="autofocus" required>
                                <?php if (!empty($client)) : ?>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            <input name="invoice_date_created" id="invoice_date_created" class="form-control datepicker" value="<?php echo date(date_format_setting()); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="invoice_group_id" id="invoice_group_id" class="form-control simple-select" data-minimum-results-for-search="Infinity" required>
                            <?php foreach ($invoice_groups as $invoice_group) { ?>
                                <option value="<?php echo $invoice_group->invoice_group_id; ?>" <?php if (get_setting('default_'.$group.'_group') == $invoice_group->invoice_group_id) { ?>selected="selected" <?php } ?>>
