...
<div id="create-invoice" class="modal modal-lg"
    ...
    <form class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="panel-title"><?php _trans('create_reservation'); ?></h4>
        </div>
                ...
                <select name="invoice_group_id" id="invoice_group_id"
                    ...
                    <?php foreach ($invoice_groups as $invoice_group) { ?>
                        <option value="<?php echo $invoice_group->invoice_group_id; ?>"
                                <?php if (get_setting('default_reservation_group') == $invoice_group->invoice_group_id) { ?>selected="selected"<?php } ?>>
